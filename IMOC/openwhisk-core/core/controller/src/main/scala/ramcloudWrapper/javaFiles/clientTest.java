...
public class clientTest {
    ...
    /**
     * Scale up and down a server ramcloud 
     */
    public void scaleServer(String locator, String serverId, Boolean scaleUp, String byhowmuch){
        ramcloud = new RAMCloud(locator);
        ramcloud.benchmarkScaling(true,byhowmuch,byhowmuch.length());
